...
public class Conductor extends javax.swing.JFrame {
    ...
    public Conductor() {
     ...
     void cargar(String valor){
            String[] titulos={"ID","RFC","Nombre","Domicilio","Telefono","FechaNacimiento","Matricula de Camion"};
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(Domc, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(fn, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void bguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bguardarActionPerformed
        ...
        sql="INSERT INTO conductor(RFC_cli, Nombre_cli, Domicilio_cli, Telefono_cli, FechaNacimiento_cli, IDcamion_cli) VALUES(?,?,?,?,?,?)";
        try {
    ...
    private void bactualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bactualizarActionPerformed
        ...
        Connection cn = cc.conexion();
        try{
            PreparedStatement pst = cn.prepareStatement("UPDATE conductor SET RFC_cli='"+rfc.getText()+"',Nombre_cli='"+nomb.getText()+"',Domicilio_cli='"+Domc.getText()+"',Telefono_cli='"+telf.getText()+"',FechaNacimiento_cli='"+fn.getText()+"',IDcamion_cli='"+AC.getSelectedIndex()+"' WHERE ID_cli='"+id.getText()+"'");
            pst.executeUpdate();
            cargar("");
            bactualizar.setEnabled(false);
            bloquear();
