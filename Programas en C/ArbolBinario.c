...
//Procedimiento para empezar a usar un árbol con la raíz vacía.
...
//Procedimiento para insertar en un árbol un nro entero que no debe existir en el mismo.
...
/* Función que determina si un nro entero está o no en el árbol.
   Devuelve 0 si no está y 1 si está. bool esta _arbol(struct árbol *raíz, int n). */
